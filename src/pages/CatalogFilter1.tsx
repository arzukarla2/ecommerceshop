...
const CatalogFilter1: FunctionComponent = () => {
  ...
  const onCatalogFilter1Click = useCallback(() => {
    navigate("/product-1");
  }, [navigate]);

  const onComponent2Container20Click = useCallback(() => {
  ...
  return (
    <>
      <div
        className="relative bg-white w-full h-[5675px] overflow-hidden cursor-pointer text-left text-sm text-black font-oswald-medium-14"
        onClick={onCatalogFilter1Click}
      >
        <div className="absolute top-[94px] left-[990px] bg-divider w-[17px] h-[17px] hidden" />
        <div className="absolute top-[133px] left-[21px] w-[1878px] h-[467px] text-lg">
        ...
        <div className="absolute top-[618px] left-[21px] leading-[68px] font-roboto-regular-14-aa text-gray-1 flex items-center w-[1878px] h-9">
          Home / Womens Dress / Best Chose
        </div>
        <div className="absolute top-[1248px] left-[21px] w-[355px] h-[285px] text-black-2 font-roboto-regular-14-aa">
        ...
        <div className="absolute top-[1920px] left-[21px] w-[355px] h-[243px] text-black-2 font-roboto-regular-14-aa">
          <div className="absolute top-[0px] left-[0px] text-5xl leading-[68px] font-oswald-medium-14 text-black flex items-center w-[182px] h-[22px]">
            Dress length
          </div>
          <div className="absolute top-[95px] left-[0px] w-[114px] h-[22px]">
        ...
        <div className="absolute top-[1593px] left-[21px] w-[355px] h-[267px] text-center text-gray-1">
          <div className="absolute top-[0px] left-[0px] text-5xl leading-[68px] text-black text-left flex items-center w-[182px] h-[22px]">
            Size (Inches)
          </div>
          <div className="absolute top-[10px] left-[343px] bg-black-2 w-3 h-0.5" />
          <div className="absolute top-[53px] left-[0px] w-[46px] h-[46px]">
          ...
          <div className="absolute top-[53px] left-[56px] w-[46px] h-[46px]">
            <div className="absolute h-[52.38%] w-full top-[23.81%] left-[0%] leading-[68px] uppercase flex items-center justify-center">
              w26
            </div>
            <img
          ...
          <div className="absolute top-[53px] left-[112px] w-[46px] h-[46px]">
            <div className="absolute h-[52.38%] w-full top-[23.81%] left-[0%] leading-[68px] uppercase flex items-center justify-center">
              w27
            </div>
            <img
          ...
          <div className="absolute top-[53px] left-[168px] w-[46px] h-[46px]">
            <div className="absolute h-[52.38%] w-full top-[23.81%] left-[0%] leading-[68px] uppercase flex items-center justify-center">
              w28
            </div>
            <img
          ...
          <div className="absolute top-[53px] left-[224px] w-[46px] h-[46px]">
            <div className="absolute h-[52.38%] w-full top-[23.81%] left-[0%] leading-[68px] uppercase flex items-center justify-center">
              w29
            </div>
            <img
          ...
          <div className="absolute top-[109px] left-[0px] w-[46px] h-[46px]">
            <div className="absolute h-[52.38%] w-full top-[23.81%] left-[0%] leading-[68px] uppercase flex items-center justify-center">
              w30
            </div>
            <img
          ...
          <div className="absolute top-[109px] left-[56px] w-[46px] h-[46px]">
            <div className="absolute h-[52.38%] w-full top-[23.81%] left-[0%] leading-[68px] uppercase flex items-center justify-center">
              w31
            </div>
            <img
          ...
          <div className="absolute top-[109px] left-[112px] w-[46px] h-[46px]">
          ...
          <div className="absolute top-[109px] left-[168px] w-[46px] h-[46px]">
            <div className="absolute h-[52.38%] w-full top-[23.81%] left-[0%] leading-[68px] uppercase flex items-center justify-center">
              w33
            </div>
            <img
          ...
          <div className="absolute top-[109px] left-[224px] w-[46px] h-[46px]">
            <div className="absolute h-[52.38%] w-full top-[23.81%] left-[0%] leading-[68px] uppercase flex items-center justify-center">
              w34
            </div>
            <img
          ...
          <div className="absolute top-[165px] left-[0px] w-[46px] h-[46px]">
            <div className="absolute h-[52.38%] w-full top-[23.81%] left-[0%] leading-[68px] uppercase flex items-center justify-center">
              w35
            </div>
            <img
          ...
          <div className="absolute top-[165px] left-[56px] w-[46px] h-[46px]">
            <div className="absolute h-[52.38%] w-full top-[23.81%] left-[0%] leading-[68px] uppercase flex items-center justify-center">
              w36
            </div>
            <img
          ...
          <div className="absolute top-[165px] left-[112px] w-[46px] h-[46px]">
            <div className="absolute h-[52.38%] w-full top-[23.81%] left-[0%] leading-[68px] uppercase flex items-center justify-center">
              w38
            </div>
            <img
          ...
          <div className="absolute top-[165px] left-[168px] w-[46px] h-[46px]">
            <div className="absolute h-[52.38%] w-full top-[23.81%] left-[0%] leading-[68px] uppercase flex items-center justify-center">
              w40
            </div>
            <img
          ...
          <div className="absolute top-[165px] left-[224px] w-[46px] h-[46px]">
            <div className="absolute h-[52.38%] w-full top-[23.81%] left-[0%] leading-[68px] uppercase flex items-center justify-center">
              w42
            </div>
            <img
          ...
          <div className="absolute top-[221px] left-[0px] w-[46px] h-[46px]">
            <div className="absolute h-[52.38%] w-full top-[23.81%] left-[0%] leading-[68px] uppercase flex items-center justify-center">
              w44
            </div>
            <img
          ...
          <div className="absolute top-[221px] left-[56px] w-[46px] h-[46px]">
            <div className="absolute h-[52.38%] w-full top-[23.81%] left-[0%] leading-[68px] uppercase flex items-center justify-center">
              w46
            </div>
            <img
          ...
          <div className="absolute top-[221px] left-[112px] w-[46px] h-[46px]">
            <div className="absolute h-[52.38%] w-full top-[23.81%] left-[0%] leading-[68px] uppercase flex items-center justify-center">
              w48
            </div>
            <img
          ...
          <div className="absolute top-[221px] left-[168px] w-[46px] h-[46px]">
            <div className="absolute h-[52.38%] w-full top-[23.81%] left-[0%] leading-[68px] uppercase flex items-center justify-center">
              w50
            </div>
            <img
          ...
          <div className="absolute top-[221px] left-[224px] w-[46px] h-[46px]">
            <div className="absolute h-[52.38%] w-full top-[23.81%] left-[0%] leading-[68px] uppercase flex items-center justify-center">
              w52
            </div>
            <img
        ...
        <div className="absolute top-[672px] left-[1555px] w-[255px] h-[46px]">
          <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] box-border border-[1px] border-solid border-divider" />
          <img
        ...
        <div className="absolute top-[672px] left-[1830px] w-[69px] h-[46px]">
        ...
        <div
          ...
          onClick={onComponent2Container20Click}
        >
          <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] bg-black" />
        ...
        <div className="absolute top-[5048px] left-[0px] w-[1920px] h-[100px]">
        ...
        <div className="absolute top-[5148px] left-[0px] w-[1920px] h-[527px] text-lg text-white">
          <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] bg-black" />
        ...
        <div className="absolute top-[672px] left-[21px] bg-white box-border w-[365px] h-[516px] border-[1px] border-solid border-black" />
        <div className="absolute top-[700px] left-[44px] text-13xl leading-[68px] flex items-center w-80 h-[22px]">
          Filter
        </div>
        <div className="absolute top-[705px] left-[291px] w-[73px] h-6">
          <div className="absolute top-[0px] left-[17px] leading-[68px] uppercase flex items-center w-14 h-6">
            reset all
          </div>
          <img
            className="absolute top-[7.65px] left-[-0.35px] w-[9.19px] h-[9.19px]"
            alt=""
            src="/vector9.svg"
          />
          <img
        ...
        <div className="absolute top-[768px] left-[44px] w-[182px] h-[62px] font-roboto-regular-14-aa">
          <div className="absolute top-[38px] left-[1px] w-[73px] h-6">
            <div className="absolute top-[0px] left-[17px] leading-[68px] uppercase flex items-center w-14 h-6">
              bardot
            </div>
            <img
          ...
          <div className="absolute top-[38px] left-[88px] w-[73px] h-6">
            <div className="absolute top-[0px] left-[17px] leading-[68px] uppercase flex items-center w-14 h-6">
              Cooper
            </div>
            <img
        ...
        <div className="absolute top-[850px] left-[44px] w-[182px] h-[62px] font-roboto-regular-14-aa">
          <div className="absolute top-[38px] left-[1px] w-[73px] h-6">
            <div className="absolute top-[0px] left-[17px] leading-[68px] uppercase flex items-center w-14 h-6">
              W32
            </div>
        ...
        <div className="absolute top-[932px] left-[44px] w-[182px] h-[62px] font-roboto-regular-14-aa">
          <div className="absolute top-[38px] left-[1px] w-[109px] h-6">
            <div className="absolute top-[0px] left-[17px] leading-[68px] uppercase flex items-center w-[92px] h-6">
              hight low
            </div>
            <img
              className="absolute top-[7.65px] left-[-0.35px] w-[9.19px] h-[9.19px]"
        ...
        <div className="absolute top-[1098px] left-[44px] w-[182px] h-[62px] font-roboto-regular-14-aa">
          <div className="absolute top-[38px] left-[1px] w-36 h-6">
            <div className="absolute top-[0px] left-[17px] leading-[68px] uppercase flex items-center w-[127px] h-6">
              0.00 EUR – 250 EUR
            </div>
            <img
              className="absolute top-[7.65px] left-[-0.35px] w-[9.19px] h-[9.19px]"
        ...
        <div className="absolute top-[1014px] left-[44px] w-[182px] h-[54.49px] text-5xl">
          <div className="absolute top-[0px] left-[0px] leading-[68px] flex items-center w-[182px] h-[22px]">
            Color:
          </div>
          <img
            className="absolute top-[45.65px] left-[0.65px] w-[9.19px] h-[9.19px]"
            alt=""
            src="/group-28.svg"
          />
        </div>
        <div className="absolute top-[2606px] left-[21px] w-[355px] h-[22px] text-5xl">
          <div className="absolute top-[0px] left-[0px] leading-[68px] flex items-center w-[182px] h-[22px]">
            Dress Length
          </div>
          <div className="absolute top-[10px] left-[343px] bg-black-2 w-3 h-0.5" />
        ...
        <div className="absolute top-[2688px] left-[21px] w-[355px] h-[295px] text-5xl">
          <div className="absolute top-[0px] left-[0px] leading-[68px] flex items-center w-[182px] h-[22px]">
            About Dresses
          </div>
        ...
        <div className="absolute top-[2380px] left-[21px] w-[355px] h-[166px] font-roboto-regular-14-aa">
        ...
        <div className="absolute top-[2219px] left-[21px] w-[355px] h-[101px] text-5xl">
          <div className="absolute top-[0px] left-[0px] leading-[68px] flex items-center w-[182px] h-[22px]">
            Color
          </div>
          <div className="absolute top-[10px] left-[343px] bg-black-2 w-3 h-0.5" />
        ...
        <div className="absolute top-[738px] left-[445px] w-[1454px] h-[4227px] text-xs">
          ...
          <div
            className="absolute top-[0px] left-[1110px] w-[344px] h-[548px] cursor-pointer"
        ...
        <div className="absolute top-[1051px] left-[70px] bg-white box-border w-[27px] h-[27px] border-[1px] border-solid border-divider" />
        <div className="absolute top-[1056px] left-[75px] bg-darkslategray w-[17px] h-[17px]" />
      </div>
      {isSignInPopUp1Open && (
        <PortalPopup
